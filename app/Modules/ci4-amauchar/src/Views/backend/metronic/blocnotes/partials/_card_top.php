    ...
    <div class="card-header pt-10">
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
                <h2 class="mb-1"><?= ucfirst(lang('Core.blocnoteType')); ?></h2>
    ...
    <div class="card-body pb-0">
        ...
        <div class="d-flex overflow-auto h-55px">
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6 <?= $active == 'general' ? 'active' : ''; ?>" href="<?= route_to('blocsnotes.index'); ?>"><?= ucfirst(lang('Core.general')); ?></a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6 <?= $active == 'type' ? 'active' : ''; ?>" href="<?= route_to('blocsnotestype.index'); ?>"><?= ucfirst(lang('Core.type')); ?></a>
                </li>
                <!--end::Nav item-->
            </ul>
        </div>
