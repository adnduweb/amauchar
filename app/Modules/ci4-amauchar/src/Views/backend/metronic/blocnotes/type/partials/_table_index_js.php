...
var KTUserList = function () {
    ...
    var initUserTable = function () {
        ...
        window.Ci4DataTables["kt_table_<?= $name; ?>-table"] = $(table).DataTable({
            ...
            'columnDefs': [
                { 
                    data: 'id_type_blocnote',
                    targets: 0,
                    render: function(data, type, full, meta) {
                        return '<td class="text-right py-0 align-middle">\
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">\
                                        <input class="form-check-input group-checkable" type="checkbox" data-id_type_blocnote="' + full.id_type_blocnote + '" value="' + full.id_type_blocnote + '" />\
                                    </div>\
                                </td>';
                    },
                    orderable: false
                    ...
                    render: function(data, type, full, meta) {
                        return '<div class="d-flex align-items-center">\
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">\
                                        <a href="' + current_url + '/edit/' + full.id_type_blocnote + '">\
                                    ...
                                    <div class="d-flex flex-column">\
                                        <a href="' + current_url + '/edit/' + full.id_type_blocnote + '" class="text-gray-800 text-hover-primary mb-1">' + full.titre + '</a>\
                                    </div>\
                                    <!--begin::User details-->\
                                </div>';
                    },
                ...
                { 
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        htmlContent += '<a href="' + current_url + '/edit/' + full.id_type_blocnote + '" class="menu-link px-3">Edit</a>'; 
                        htmlContent +=  '</div>';
                        htmlContent +=  '<!--end::Menu item-->';
                        htmlContent +=  '<!--begin::Menu item-->';
                        htmlContent +=  '<div class="menu-item px-3">';
                        htmlContent +=  '<a href="#" class="menu-link px-3" data-id_type_blocnote="' + full.id_type_blocnote + '" data-kt-<?= $name; ?>-table-filter="delete_row">Delete</a>';
                        htmlContent +=  '</div>';
                        htmlContent +=  '<!--end::Menu item-->';
                        htmlContent +=  '</div>';
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                var id_type_blocnote = $(this).data('id_type_blocnote');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        const packets = {
                            id_type_blocnote:  [id_type_blocnote]
                        };
