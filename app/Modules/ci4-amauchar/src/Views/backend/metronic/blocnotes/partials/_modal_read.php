<!--begin::Modal-->
<div class="modal fade" id="read-contenu" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header text-center w-100">
                    <!--begin::Modal title-->
                <h2 class="fw-bolder text-gray-800 mb-1"><?= lang('Core.contenu'); ?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
