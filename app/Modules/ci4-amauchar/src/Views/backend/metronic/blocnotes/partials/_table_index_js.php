            ...
            'columnDefs': [
                        ...
                        return '<div class="d-flex align-items-center">\
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">\
                                        <a href="' + current_url + '/edit/' + full.uuid + '">\
                                            <div class="symbol-label fs-3 bg-light-danger text-danger">' + (full.titre).substr(0,1).toUpperCase() +  '</div>\
                                        </a>\
                                    </div>\
                                    <!--end::Avatar-->\
                                    <!--begin::User details-->\
                ...
                { 
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return  '<div>' + full.contenu_read + ' <a href="'+current_url+'" class="btn btn-sm btn-light-primary" data-uuid="' + full.uuid + '" data-contenu="read" >voir le contenu</a></div>';
                ...
                { 
                    data: 'blocnote_type_id',
                    targets: 3,
                    render: function(data, type, full, meta) {
                       
                        return (full.blocnote_type_id == '') ? 'aucun' : '<span class="text-gray-800 text-hover-primary mb-1">' + full.blocnote_type_id + '</span>'                      
                    },
                    orderable: false,
                    searchable: false
                }, 
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        <?php if(service('settings')->get('App.forceUnlockMdp', 'user:' . Auth()->user()->id) == true){ ?>
                        ...
                        preConfirm: (mdp) => {
                            return axios.post("<?= route_to('users.verif.mdp') ?>", {mdp: mdp})
            ...
            d.addEventListener('click', function (e) {
                ...
                <?php if(service('settings')->get('App.forceUnlockMdp', 'user:' . Auth()->user()->id) == true){ ?>
                    ...
                    const formData = new FormData();
                        ...
                        axios.post("<?= route_to('blocsnotes.read.contenu') ?>", formData)
                        .then( response => {
                            console.log(('fafa'));
