        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_<?= $name; ?>">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px" title="contenu"><?= lang('Core.contenu'); ?></th>
                    <th class="min-w-125px" title="blocnote_type_id"><?= lang('Core.type'); ?></th>
...
<?= $this->include('Amauchar\Core\Views\backend\metronic\blocnotes\partials\_modal_read') ?>
<?= $this->endSection() ?>

<?= $this->section('pageAdminScripts') ?>
<?= $this->include('Amauchar\Core\Views\backend\metronic\blocnotes\partials\_table_index_js') ?>
<?= $this->endSection() ?>
