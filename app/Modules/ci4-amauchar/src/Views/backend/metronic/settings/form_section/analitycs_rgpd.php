...
<div class="row mb-10">
    <label for="tagManager" class="col-lg-4 col-form-label required fw-bold fs-6"><?= ucfirst(lang('Core.tagManager')); ?>* : </label>
     <div class="col-lg-8">
        <input class="form-control form-control-solid" type="text" value="<?= old('tagManager') ? old('tagManager') : service('settings')->get('Consent.tagManager'); ?>" name="core[tagManager]" id="tagManagercode">
    </div>
</div>
...
<div class="row mb-10">
    <label for="googleAnalitycs" class="col-lg-4 col-form-label required fw-bold fs-6"><?= ucfirst(lang('Core.googleAnalitycsCode')); ?>* : </label>
        <div class="col-lg-8">
        <input class="form-control form-control-solid" type="text" value="<?= old('core.googleAnalitycs_' .service('request')->getLocale()) ? old('core.googleAnalitycs_' .service('request')->getLocale()) : service('settings')->get('Consent.googleAnalitycs_' .service('request')->getLocale()); ?>" name="core[googleAnalitycs_<?= service('request')->getLocale(); ?>]" id="consent-googleAnalitycs_<?= service('request')->getLocale(); ?>" id="googleAnalitycs">
    </div>
</div>
...
<div class="row mb-10">
    <label for="google_maps" class="col-lg-4 col-form-label required fw-bold fs-6"><?= ucfirst(lang('Core.googleMaps')); ?>* : </label>
     <div class="col-lg-8">
        <input class="form-control form-control-solid" type="text" value="<?= old('googleMaps') ? old('googleMaps') : service('settings')->get('Consent.googleMaps'); ?>" name="core[googleMaps]" id="googleMaps">
    </div>
</div>
