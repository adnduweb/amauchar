...
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0"><?= ucfirst(lang('Core.from')); ?></h3>
        </div>
        <!--end::Card title-->
    </div>
    ...
    <div class="card-body border-top p-9">
        ...
        <p><?= ucfirst(lang('Core.thisSpecifiesTheDefaultEmailAddress')); ?></p>

        <div class="row mb-5">
            <!-- Name -->
            <div class="form-group col">
                <label class="form-label" for="fromName"><?= ucfirst(lang('Core.name')); ?></label>
...
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        <!--begin::Card title-->
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0"><?= ucfirst(lang('Core.mailSettings')); ?></h3>
        </div>
        <!--end::Card title-->
    </div>

    <div class="card-body border-top p-9" x-data="{openTab: <?= $activeTab ?>}">

        <p><?= ucfirst(lang('Core.selectTheProtocolUsedWhenSendingMail')); ?></p>

        <div class="row mb-5">
            <div class="form-group col-12 col-sm-6 col-md-3">
                <label class="form-label" for="protocol">Protocol</label>
                <select data-kt-select2="true" name="protocol" id="protocol" class="form-select">
        ...
        <div class="tab-content mx-5 mt-3">
            ...
            <div id="mail-settings" x-show="openTab == 1">
                <p class="alert alert-info"><?= ucfirst(lang('Core.MailIsOnlyAvailableOnLinuxServers')); ?></p>
            </div>
            ...
            <div id="mail-settings" x-show="openTab == 3">
                <!-- Host -->
                <div class="row mb-5" x-data="{open: 0}">
