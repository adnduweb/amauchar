...
<div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
    <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title mb-10">
                <?= lang('Core.fichier'); ?> : <?= $file; ?> <br/> <?= lang('Core.langue'); ?> : <?= $lang; ?>
            </h3>
        </div>
    </div>
    ...
    <div class="kt-portlet__body">
        ...
        <?php foreach ($langue as $k => $v) { ?>
            <div class="form-group row">
                <div class="col-lg-5">
                    ...
                    <input disabled type="text" class="form-control" placeholder="<?= lang('Core.enterTexte'); ?>" value="<?= $k; ?>">
                </div>
                <div class="col-lg-5">
                    <label><?= lang('Core.label_value'); ?>: </label>
                    <input type="text" class="form-control" placeholder="<?= lang('Core.enterValue'); ?>" name="traduction[<?= $k; ?>]" value="<?= $v; ?>">
                </div>
        ...
        <div id="kt_repeater_1">
            <div data-repeater-list="kt_traduction">
                <div data-repeater-item class="form-group row sur">

                    <div class="col-lg-5">
                        <label><?= lang('Core.label_texte'); ?>: </label>
                        <input type="text" class="form-control" placeholder="<?= lang('Core.enterTexte'); ?>" name="texte" value="">
                    </div>
                    <div class="col-lg-5">
                        <label><?= lang('Core.label_value'); ?>: </label>
                        <input type="text" class="form-control" placeholder="<?= lang('Core.enterValue'); ?>" name="value" value="">
                    </div>
                    <div class="col-lg-2 action" style="padding: 18px;">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4">
                    <a href="javascript:;" data-repeater-create="" class="btn btn-bold btn-sm btn-light-primary">
                        <i class="la la-plus"></i> <?= lang('Core.addItemTraduction'); ?>
                    </a>
                </div>
            </div>
        </div>
