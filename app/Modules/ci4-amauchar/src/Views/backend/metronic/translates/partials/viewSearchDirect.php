    ...
    <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                <?= lang('Core.nbreResultat', [$searchTextLang]); ?>
            </h3>
        </div>
    </div>
        ...
        <?php foreach ($searchTextLang as $v) { ?>
            ...
            <div class="form-group row">
                <div class="col-lg-5">
                    ...
                    <input disabled type="text" class="form-control" placeholder="<?= lang('Core.enterTexte'); ?>" value="traduction[<?= $v['info_key']; ?>]">
                   
                </div>
                <div class="col-lg-5">
                    <label><?= lang('Core.label_value'); ?>: </label>
                    <input type="text" class="form-control" placeholder="<?= lang('Core.enterValue'); ?>" name="traduction[<?= $v['info_key']; ?>]" value="<?= $v['info_name']; ?>">
                </div>
