            ...
            'columnDefs': [
                        ...
                        return '<div class="d-flex align-items-center">\
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">\
                                        <a href="' + current_url + '/edit/' + full.uuid + '">\
                                            <div class="symbol-label fs-3 bg-light-danger text-danger">' + (full.last_name).substr(0,1).toUpperCase() + ' ' + (full.first_name).substr(0,1).toUpperCase() + '</div>\
                                        </a>\
                                    </div>\
                                    <!--end::Avatar-->\
                                    <!--begin::User details-->\
                                    <div class="d-flex flex-column">\
                                        <a href="' + current_url + '/edit/' + full.uuid + '" class="text-gray-800 text-hover-primary mb-1">' + full.last_name + ' ' + full.first_name + '</a>\
                                        <span class="text-gray-800 text-hover-primary mb-1">' + full.secret + '</span>\
                                    </div>\
                                    <!--begin::User details-->\
                                </div>';
                    },
                ...
                { 
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return '<div class="badge badge-primary fw-bolder capitalize">' + full.username + '</div>';                    
                    },
                    orderable: true,
                    searchable: true
                },   
                { 
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return (full.last_used_at == '') ? 'aucune connexion' : '<div class="badge badge-light fw-bolder">' + full.last_used_at + '</div>';                
                    },
                    orderable: true,
                    searchable: true
                }, 
                { 
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return (full.type == '') ? 'aucun' : '<span class="text-gray-800 text-hover-primary mb-1">' + full.type + '</span>'                      
                    },
                    orderable: false,
                    searchable: false
                }, 
