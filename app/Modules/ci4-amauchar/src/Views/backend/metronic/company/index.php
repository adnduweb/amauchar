                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    <th class="w-10px pe-2">
                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                            <input class="form-check-input allCheck" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_compny .form-check-input" value="1" />
                        </div>
                    </th>
                    <th class="min-w-125px" title="Raison social"><?= lang('Core.raisonSocial'); ?></th>
                    <th class="min-w-125px" title="email"><?= lang('Core.email'); ?></th>
                    <th class="min-w-125px" title="adresse"><?= lang('Core.adresse'); ?></th>
...
<?= $this->include('Amauchar\Core\Views\backend\metronic\company\partials\_table_index_js') ?>
<?= $this->endSection() ?>