        ...
        window.Ci4DataTables["kt_table_<?= $name; ?>-table"] = $(table).DataTable({
            ...
            'columnDefs': [
                ...
                },
                {
                    ...
                    targets: 1,
                    render: function(data, type, full, meta) {
                        var ukDatea = full.source.split('\/');
                        return ukDatea.at(-1) + ': ' + full.source_id;
                    },
                    orderable: true,
                    searchable: true
                },
                ...
                },
                {
                   ...
                   render: function(data, type, full, meta) {
                    if(full.data !=''){
                           var obj = jQuery.parseJSON( full.properties );
                           var code = '<code> ' + full.properties + '</code>';
                       } else{
                        var code =  '';
                       }
