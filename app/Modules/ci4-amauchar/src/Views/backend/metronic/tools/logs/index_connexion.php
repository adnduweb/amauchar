        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_<?= $name; ?>">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px" title="Name"><?= lang('Core.adressIp'); ?></th>
                    <th class="min-w-125px" title="Event"><?= lang('Core.agentUser'); ?></th>
                    <th class="min-w-125px" title="Summary"><?= lang('Core.Name'); ?></th>
                    <th class="min-w-125px" title="User"><?= lang('Core.etat'); ?></th>
...
<?= $this->include('Amauchar\Core\Views\backend\metronic\tools\logs\_table_index_connexion_js') ?>
<?= $this->endSection() ?>