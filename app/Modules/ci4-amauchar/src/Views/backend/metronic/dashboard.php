...
<div class="d-flex align-items-center rounded border-info border border-dashed rounded-3 py-5 px-4 bg-light-info ">
   ...
   <div class="d-flex h-80px w-80px flex-shrink-0 flex-center position-relative ms-3 me-6">
        <?= theme()->getSVG("icons/duotone/Layout/Layout-polygon.svg", "svg-icon svg-icon-info position-absolute opacity-10"); ?>
        <?= theme()->getSVG("icons/duotune/art/art006.svg", "svg-icon svg-icon-3x svg-icon-info  position-absolute"); ?>
