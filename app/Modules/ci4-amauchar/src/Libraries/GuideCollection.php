...
class GuideCollection
{
    ...
    public function tableOfContents(): string
    {
        ...
        ksort($pages);
        // print_r($this->settings['path']); exit;
        //print_r($pages); exit;

        return view('\Amauchar\Core\Views\backend\\'.ADMIN_THEME.'\guides\_toc', [
            'pages' => $pages,
            'alias' => $this->alias,
        ]);
    }
    ...
    public function pageLinks()
    {
        ...
        return view('\Amauchar\Core\Views\backend\\'.ADMIN_THEME.'\guides\_page_links', [
