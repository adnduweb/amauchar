...
use Amauchar\Core\Libraries\BootstrapBase;
use Amauchar\Core\Libraries\MenuAdmin;
...
class BootstrapDemo1 extends BootstrapBase {
    ...
    private static function initHorizontalMenu() {
        self::$horizontalMenu = new MenuAdmin(  Config('AdminMenu')->horizontal, Theme::getPagePath() );
