...
trait HasMenuIcons
{
     ...
     * @return $this
     */
    public function setIconSvg(array $svg)
    {
        $this->iconSvg = $svg;
    ...
    public function icon(string $class = ''): string
    {
        ...
        if (! empty($this->iconSvg)) {
            return $this->buildSvgIconTag();
        }
     ...
     * @return string
     */
    protected function buildSvgIconTag()
    {
        return theme()->getSVG($this->iconSvg[0], $this->iconSvg[1]);
    }
}
