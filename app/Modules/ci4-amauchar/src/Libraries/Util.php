...
class Util {
    ...
    */
    ...
    public static function notice($text, $state = 'danger', $icon = 'icons/duotune/art/art006.svg') {
        ...
        $html .= '      ' . theme()->getSvg("icons/duotune/abstract/abs051.svg", "svg-icon-" . $state . " position-absolute opacity-10", "w-80px h-80px");
        $html .= '	    ' . theme()->getSvg($icon, "svg-icon-3x svg-icon-" . $state . "  position-absolute");
        $html .= '  </div>';
        $html .= '  <!--end::Icon-->';
    ...
    public static function info($text, $state = 'danger', $icon = 'icons/duotune/general/gen044.svg') {
        ...
        $html .= '    <!--begin::Icon-->';
        $html .= '	  ' . theme()->getSvg($icon, 'svg-icon-3x svg-icon-' . $state . ' me-5');
        $html .= '    <!--end::Icon-->';
     ...
     */
    public static function stringClean($string, $strtocase = null, $preserve = '')
    {
        $unsafe = array(
     ...
     * @return string la chaine nettoyée
     */
    public static function stringCleanUrl($string)
    {
        $retour = self::stringClean($string, "lower");
     ...
     public static function replaceInfile($file, $find, $replace)
        ...
        public static function secret_mail($email)
        {
            ...
            return substr_replace ( $mail_parts[0] , $replace , $show, $hide ) . "@" . substr_replace($mail_parts[1], "**", 0, 5);
        }
        ...
        public static function secret($data)
        {
            ...
            $nb_caractere_visible = 5;
            $remplacement = '*';
            $longueur_mdp = strlen($data);
             
            $partie_visible = substr($data, 0, $nb_caractere_visible);
