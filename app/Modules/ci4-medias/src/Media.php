    ...
    public function addParamsJs(){
		...
		$paramJs =
			json_encode([
				...
				'acceptedFiles'      => setting('Medias.acceptedFiles'),
				'uploadLimitBytes'   => max_file_upload_in_bytes(),
				'urlUpload'          => site_url(route_to('media.upload')),
				'editionImage'       => site_url(route_to('media.edition.image')),
				'saveEditionImage'   => site_url(route_to('media.edition.image.save')),
				'deleteEditionImage' => site_url(route_to('medias.remove.file')),
