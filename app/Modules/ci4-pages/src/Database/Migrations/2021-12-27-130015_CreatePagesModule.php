...
class CreateTablePages extends Migration
{
    public function up()
    {
        $fields = [
            ...
            'display_title'      => ['type' => 'INT', 'constraint' => 11, 'default' => 1],
        ...
        $fields = [
            ...
            'robots'              => ['type' => 'VARCHAR', 'constraint' => 255],
            'og_type'             => ['type' => 'VARCHAR', 'constraint' => 255],
            'og_title'            => ['type' => 'VARCHAR', 'constraint' => 255],
            'og_description'      => ['type' => 'VARCHAR', 'constraint' => 255],
            'twitter_type'        => ['type' => 'VARCHAR', 'constraint' => 255],
            'twitter_title'       => ['type' => 'VARCHAR', 'constraint' => 255],
            'twitter_description' => ['type' => 'VARCHAR', 'constraint' => 255],
