    ...
    <div class="card-body p-5">
        ...
        <div class="row">
                ...
                <h2 style="margin-bottom:30px;">Menu : <?= $menu_item->name; ?></h2>
                    <table id="kt_file_manager_list" class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="fw-bold text-gray-600">          
                            <div id="draggable2">
                            <?= $this->include('\Amauchar\Pages\Views\backend\themes\metronic\menus\__form_section\get_menu'); ?>
                            </div>
                        </tbody>
                        <!--end::Table body-->
                    </table>
            ...
            <div class="col-xl-5 col-lg-5 order-lg-3 order-xl-1 kt-section">
                <?= $this->include('\Amauchar\Pages\Views\backend\themes\metronic\menus\__form_section\form_menu'); ?>
