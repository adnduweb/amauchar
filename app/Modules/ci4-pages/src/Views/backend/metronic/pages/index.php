...
<?= view('Amauchar\Pages\Views\backend\metronic\pages\partials\cartd_top', ['itemCount' => $itemCount, 'active' => $active, 'name' => $name]) ?>
...
<?= $this->include('Amauchar\Pages\Views\backend\metronic\pages\partials\_table_index_js') ?>
<?= $this->endSection() ?>
