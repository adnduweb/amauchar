...
var defaults = {
    ...
    "language": {
        ...
        'processing': '<div class="loaderContainer"><div class="loader"><img src="/backend/themes/metronic/assets/media/loader/loader.svg" alt="Traitement en cours..."></div><div class="textProcessing">Traitement en cours...</div></div>',
    ...
    error: function() {
        Swal.fire({
            title: 'Erreur',
            type: 'error',
            html: '<p style="display: block;">Une erreur est survenue</p><br><a href="javascript:;" class="swal2-confirm btn btn-primary btn-md" onclick="location.reload()"><i class="fa fa-check"></i><span>Ok</span></a>',
