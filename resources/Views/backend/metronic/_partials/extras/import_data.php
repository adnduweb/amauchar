...
<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_import_datatable">
    <?= theme()->getSVG('icons/duotune/arrows/arr077.svg', "svg-icon svg-icon-2"); ?>
    <?= ucfirst(lang('Core.import')); ?>
</button>
<!--end::Export-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder"><?= lang('Core.Importer: %s', [singular($name)]); ?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
...
var KTDropzoneDemo = function () {
    ...
    var demo1 = function () {
        ...
        $('#kt_dropzone_1').dropzone({
            url: "<?= route_to(singular($name) . '-import-ajax') ?>", // Set the url for your upload script location
            headers: {
