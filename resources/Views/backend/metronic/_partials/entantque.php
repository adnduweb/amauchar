	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder text-gray-800 mb-1"><?= lang('Core.searchUsers'); ?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
			...
			<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
				...
				<div class="text-center mb-12">
					<div class="text-gray-400 fw-bold fs-5"><?= lang('Core.listUsersApps'); ?></div>
				</div>
				<!--end::Content-->
				<!--begin::Search-->
					...
					<div class="py-5">
						...
						<div data-kt-search-element="suggestions">
							...
							<div class="text-center px-4 pt-10">
								<img src="<?=theme()->getMediaUrl('illustrations/sketchy-1/4.png'); ?>" alt="" class="mw-100 mh-200px" />
							</div>
							<!--end::Illustration-->
						</div>
						<!--end::Suggestions-->
						...
						<div id="kt-search-users-element" data-kt-search-element="results" class="d-none">
							<?= view('\Themes\backend\metronic\_partials\search_users', ['list_users' => '']) ?>
						</div>
						<!--end::Results-->
						<!--begin::Empty-->
						<div data-kt-search-element="empty" class="text-center d-none">
							...
							<div class="text-center px-4">
								<img src="<?=theme()->getMediaUrl('illustrations/sketchy-1/9.png'); ?>" alt="user" class="mw-100 mh-200px" />
							</div>
							<!--end::Illustration-->
						</div>
						<!--end::Empty-->
        ...
        var timeout = setTimeout(function() {
           ...
           // Hide recently viewed
            ...
            if (inputElement.value.length >=  3) {
				...
				axios.get("<?= route_to('users.list.ajax'); ?>", {params: {s: inputElement.value}})
				.then(response => {
	...
	return {
		init: function() {
            ...
            KTUtil.on(element, '[data-kt-search-element="customer"]', 'click', function() {
				...
				axios.post('<?= route_to('users.entantque.comfirm'); ?>', packets)
				.then(response => {
